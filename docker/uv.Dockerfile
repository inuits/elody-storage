...
FROM ${UV_IMAGE_PREFIX}/astral-sh/uv:0.11.16 as uv_binary
...
RUN apk add --no-cache libmagic libmediainfo && adduser --disabled-password --home /app --shell /bin/bash app
